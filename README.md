...
+ `go get github.com/wangyuanchen/go-mysql-elasticsearch-elasticsearch`, it will print some messages in console, skip it. :-)
+ cd `$GOPATH/src/github.com/wangyuanchen/go-mysql-elasticsearch-elasticsearch`
+ `make`
